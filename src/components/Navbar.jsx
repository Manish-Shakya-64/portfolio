...
const Navbar = ({ currentTab, setCurrentTab }) => {
    ...
    return (
        <>
            {/* navbar for desktop */}
            <div className='hidden lg:block absolute top-0 right-0 w-[60%] bg-gray-2 z-[1] rounded-bl-3xl rounded-tr-3xl border border-ternary backdrop-blur-3xl'>
                <ul className='flex items-center justify-center gap-16 py-1'>
                    {
                        tabs.map((tab, index) => (
            ...
            <div className='lg:hidden fixed bottom-0 left-0 right-0 bg-gray-2 z-50 border-t border-ternary backdrop-blur-[100px] rounded-t-2xl'>
